            ...
            <div class="card">
                <div class="card-header py-3">
                    <div class="d-flex align-items-center">
                        <h5>Lista de Tribunales Arbitrales</h5>
                ...
                <div class="card-body">
                    <div class="row">
                        <label class="form-label">Seleccione un Distrito /sede :</label>
                    </div>
                    <div class="row mb-3">
                        ...
                        <table class="table" id="table" ref="myDataTable">
                            ...
                            <tbody>
                                <tr v-if="distrito == ''" class="text-center">
                                    <td colspan="4" class="py-3 text-secondary">Seleccione un Distrito / Sede</td>
                                </tr>
                                <tr v-for="(juzgado, index) in juzgados" :key="index" v-if="juzgado.type_id==3">
