                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table" id="table" ref="myDataTable">
                            ...
                            <tbody>
                                <tr v-for="(instancia, index) in instancias" :key="index" v-if="instancia.type_id==1">
                ...
                <div class="modal-content card border-0" @click.stop>
                    <div class="card-header">
                        <h5 class="text-center">
                            {{ instancia.ins_id ? 'Actualizar Instancia' : 'Registar Nueva Instancia' }}
                        </h5>
                    </div>
    ...
    methods: {
        ...
        async crear() {
            ...
            try {
                ...
                const response = await this.$postData('instance/store', this, formData);
        ...
        async actualizar(id) {
            ...
            try {
                ...
                const response = await this.$putData('instance/update', this, formData);
        ...
        async borrar(id) {
            this.$warningAlertWithCancel('Confirmar Eliminación', '¿Estás seguro de que deseas eliminar esta Instancia?', async () => {
                try {
                    ...
                    const response = await this.$deleteData('instance/destroy', this, formData);
