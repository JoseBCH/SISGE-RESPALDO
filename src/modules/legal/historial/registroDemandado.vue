                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="demandado" class="form-control border-0" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
        ...
        async buscar() {
            try {
                ...
                const response = await this.$axios.post(
                    `${this.$store.getters.get__url}/demandado/expedientes`,
                    {
                ...
                if (response.data.tipo_persona === 'NATURAL') {
                    this.demandado = `${response.data.persona.nat_nombres} ${response.data.persona.nat_apellido_paterno} ${response.data.persona.nat_apellido_materno} `;
                } else {
                    this.demandado = response.data.persona.jur_razon_social;
                }
        ...
        async guardar() {
            ...
            try {
                ...
                if (response.data.state === 0) {
                    this.$router.push({ path: '/sisge/demandados' });
                }
            } catch (error) {
