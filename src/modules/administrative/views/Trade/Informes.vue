                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <a href="javascript:void(0)" class="py-0 w-100 ">
                                        <div class="d-flex align-items-center p-2 bg-light rounded"
                                            ...
                                            <div class="px-2">Oficios en Trámite</div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <a href="javascript:void(0)" class="py-0 w-100 ">
                                        <div class="d-flex align-items-center p-2 bg-light rounded"
                                            ...
                                            <div class="px-2">Oficios en Ejecución</div>
                                            <i data-feather="download" class="ml-auto"></i>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <a href="javascript:void(0)" class="py-0 w-100 ">
                                        <div class="d-flex align-items-center p-2 bg-light rounded"
                                            ...
                                            <div class="px-2">Total de Oficios</div>
                                            <i data-feather="download" class="ml-auto"></i>
                                        </div>
                                    </a>
                                </div>
                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <label class="form-label">Reportes de Oficio Desde-Hasta</label>
                                    <div class="row">
                                        <div class="col-md-5">
                            ...
                            <label class="form-label">Reportes de Oficios por Mes y Año</label>
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">Reporte de Oficios por Materia</label>
                                        <div class="row">
                                            <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">Reporte de Oficios por Pretensión</label>
                                        <div class="row">
                                            <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">Reporte de Oficios asignados a un Abogado</label>
                                        <div class="row">
                                            <div class="col-md-10">
