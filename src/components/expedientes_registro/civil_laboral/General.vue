            ...
            <div class="card">
                ...
                <div class="card-body mb-0">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <v-select 
                                :options="pretenciones.filter(pretension => pretension.type_id === 1)" 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <v-select 
                                        :options="materias.filter(materia => materia.type_id === 1)"  
                                        :reduce="(materia) => materia.mat_id" 
                                        label="mat_nombre"  
                                        placeholder="-- Seleccionar"
                                        v-model="datosgenerales.exp_materia" 
                                        @input="validarCampo('exp_materia')"
                                        :class="{ 'has-error': errores.exp_materia}"
                                    />
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <v-select 
                                    :options="instancia.filter(instancia => instancia.type_id === 1)" 
                                    :reduce="(instancia) => instancia.ins_id" 
                                    label="ins_nombre"  
                                    placeholder="-- Seleccionar"
                                    v-model="datosgenerales.exp_instancia" 
                                    @input="cargarespecialidades"
                                    :class="{ 'has-error': errores.exp_instancia }"
                                />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <v-select 
                                    :options="especialidad.filter(especialidad => especialidad.type_id === 1)" 
                                    :reduce="(especialidad) => especialidad.esp_id" 
                                    label="esp_nombre"  
                                    placeholder="-- Seleccionar"
                                    v-model="datosgenerales.exp_especialidad" 
                                    @input="validarCampo('exp_especialidad')"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label mb-1">Órgano Jurisdiccional</label>
                                <v-select 
                                    :options="juzgados.filter(juzgado =>juzgado.type_id === 1)" 
