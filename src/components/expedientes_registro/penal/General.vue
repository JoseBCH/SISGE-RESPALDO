            ...
            <div class="card rounded">
                        ...
                        <div class="col-md-12 d-flex align-items-center">
                            ...
                            <div class="form-check form-switch ml-auto">
                                <input class="form-check-input" disabled type="checkbox" role="switch"
                                    id="flexSwitchCheckChecked" :checked="isMultiple == '0' ? false : true"
                                    @change="mtdChangeMultiple" />
                                <label class="form-check-label" for="flexSwitchCheckChecked">{{ isMultiple == '0' ?
                                        "Multiple Denunciante" : "Un Solo Denunciado" }}</label>
                            </div>
                        </div>
                ...
                <div class="card-body mb-0">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="404-2020"
                                    v-model="datosgenerales.carpetafiscal" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="1340-2014-21-1708-JR-PE-01"
                                    v-model="datosgenerales.exp_numero" :disabled="datosgenerales.carpetafiscal == ''" />
                                <span class="error-message" v-if="errores.exp_numero">Ingrese un numero de
                                    expediente.</span>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <v-select :options="pretenciones.filter(pretension => pretension.type_id === 2)"
                                    :reduce="(pretension) => pretension.pre_id" label="pre_nombre"
                                    placeholder="-- Seleccionar" v-model="datosgenerales.exp_pretencion"
                                    @input="validarCampo('exp_pretencion')"
                                    :class="{ 'has-error': errores.exp_pretencion }" />
                                <span class="error-message" v-if="errores.exp_pretencion">Seleccione un Delito.</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Monto de Reparación Civil</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Distrito Judicial/Penal</label>
                                <v-select :options="distritos"
                                    :reduce="(distrito) => distrito.judis_id" label="judis_nombre"
                                    placeholder="-- Seleccionar" v-model="datosgenerales.exp_distrito_judicial"
                                    @input="cargarinstancias" :class="{ 'has-error': errores.exp_distrito_judicial }" />
                                <span class="error-message" v-if="errores.exp_distrito_judicial">Seleccione un Distrito
                                    Judicial.</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Fiscalia</label>
                                <v-select
                                    :options="instancia.filter(instancia => instancia.type_id === 2 &&
                                        instancia.judis_id == datosgenerales.exp_distrito_judicial)"
                                    :reduce="(instancia) => instancia.ins_id" label="ins_nombre"
                                    placeholder="-- Seleccionar" v-model="datosgenerales.exp_instancia"
                                    @input="cargarespecialidades" :class="{ 'has-error': errores.exp_instancia }" />
                                <span class="error-message" v-if="errores.exp_instancia">Seleccione una
                                    Instancia.</span>
                            </div>
                        </div>
                    </div>
                    <!-- <div class="row">    
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="datosgenerales.exp_especialidad"
                                    :class="{ 'has-error': errores.exp_especialidad }"
                                    @change="validarCampo('exp_especialidad')">
                                    <option value="" disabled selected>-- Seleccione una opción</option>
                                    <option v-for="especialidades in especialidad" :value="especialidades.esp_id">
                                        {{ especialidades.esp_nombre }}
                                    </option>
                                </select>
                                <span class="error-message" v-if="errores.exp_especialidad">Seleccione una
                                    Especialidad.</span>
                            </div>
                        </div>
                    </div> -->
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label mb-1">Sala Penal/Juzgado</label>
                                <v-select :options="juzgados.filter(juzgado => juzgado.type_id === 2)"
                                    :reduce="(juzgado) => juzgado.co_id" label="co_nombre"
                                    placeholder="-- Seleccionar" v-model="datosgenerales.exp_juzgado"
                                    @input="validarCampo('exp_juzgado')"
                                    :class="{ 'has-error': errores.exp_juzgado }" />

                                <span class="error-message" v-if="errores.exp_juzgado">Seleccione....</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="error-message" v-if="errores.exp_estado_proceso">Selecione un estado para
                                    el
                                    Expediente.</span>
                            </div>
                        </div>
                    ...
                    <div class="row" v-if="datosgenerales.exp_estado_proceso == 'EN EJECUCION'
                                        || datosgenerales.exp_estado_proceso == 'ARCHIVADO'">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="MontoPretencion">Reparación Civil 1</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="MontoConsentido">Reparacion Civil 2</label>
