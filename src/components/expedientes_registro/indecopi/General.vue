            ...
            <div class="card shadow rounded">
                ...
                <div class="card-body mb-0">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label"> N° de Procedimiento</label>
                    ...
                    <div class="row">
                        <!-- <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select type="text" class="form-control" @change="validarCampo('exp_pretencion')"
                                    v-model="datosgenerales.exp_pretencion"
                                    :class="{ 'has-error': errores.exp_pretencion }">
                                    <option value="" disabled selected class="text-secondary">-- Seleccione una opción
                                    </option>
                                    <option v-for="pretension in pretenciones" :value="pretension.pre_id"
                                        :key="pretension.pre_id">{{
                                            pretension.pre_nombre }}</option>
                                </select>
                                <span class="error-message" v-if="errores.exp_pretencion">Seleccione ...</span>
                            </div>
                        </div> -->
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label"> Reparación Solicitada</label>
                                ...
                                <span class="error-message" v-if="errores.exp_monto_pretencion">Ingrese un monto de
                                    Reparación Solicitada.</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Oficina Regional</label>
                                <select class="form-control" @change="cargarinstancias"
                    ...
                    <!-- <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="datosgenerales.exp_materia"
                                    :class="{ 'has-error': errores.exp_materia }" @change="validarCampo('exp_materia')">
                                    <option value="" disabled selected class="py-5">-- Seleccione una opción</option>
                                    <option v-for="(materia) in materias" :key="materia.mat_id" :value="materia.mat_id"
                                        class="py-3">
                                        {{ materia.mat_nombre }}
                                    </option>
                                </select>
                                <span class="error-message" v-if="errores.exp_materia">Seleccione una Materia.</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <!-- <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="datosgenerales.exp_instancia"
                                    @change="cargarespecialidades" :class="{ 'has-error': errores.exp_instancia }">
                                    <option value="" disabled selected>-- Seleccione una opción</option>
                                    <option v-for="instancias in instancia" :value="instancias.ins_id">
                                        {{ instancias.ins_nombre }}
                                    </option>
                                </select>
                                <span class="error-message" v-if="errores.exp_instancia">Seleccione una Instancia.</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label mb-1">Tribunal de Indecopi</label>
                                <select class="form-control" v-model="datosgenerales.exp_juzgado"
                                    :class="{ 'has-error': errores.exp_juzgado }" @change="validarCampo('exp_juzgado')">
                                    <option value="" disabled selected>-- Seleccione una opción</option>
                                    <option v-for="juzgado in juzgados" :key="juzgado.co_id" :value="juzgado.co_id">
                                        {{ juzgado.co_nombre }}
                                    </option>
                                </select>
                                <span class="error-message" v-if="errores.exp_juzgado">Seleccione un Tribunal de Indecopi</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row" v-if="datosgenerales.exp_estado_proceso == 'EN RESOLUCION'
                        || datosgenerales.exp_estado_proceso == 'ARCHIVADO'">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="MontoPretencion"> Monto de la Sanción 1</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label" for="MontoConsentido"> Monto de la Sanción 2</label>
