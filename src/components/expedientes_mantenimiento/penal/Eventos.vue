                            ...
                            <div class="card-footer border-0 pt-1">
                                <div class="row">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button @click="guardarAudiencia"
                                            class="btn btn-lg btn-primary px-4">Guardar Audiencia</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        //             url: `${this.$store.getters.get__url}/proceeding/${this.$route.params.id}`,
        //             token: this.$store.getters.get__token,
        //         });
        //         console.log(response);
        //         this.expediente = response.data.exp_numero;
        //         this.pretencion = response.data.exp_pretencion;
        //         this.juzgado = response.data.ins_nombre;
        //         this.audiencia.au_lugar = response.data.nombre_juzgado;
        //         const isNaturalPerson = response.data.tipo_persona === 'Natural';
        //         this.demandante = isNaturalPerson
        //             ? response.procesal === 'demandante'
        //                 ? `${response.data.nat_apellido_paterno} ${response.data.nat_apellido_materno} ${response.data.nat_nombres}`
        //                 : 'UNPRG'
        //             : response.procesal === 'demandante'
        //                 ? response.data.jur_razon_social
        //                 : 'UNPRG';
        //         this.demandado = isNaturalPerson
        //             ? response.procesal === 'demandante'
        //                 ? 'UNPRG'
        //                 : `${response.data.nat_apellido_paterno} ${response.data.nat_apellido_materno} ${response.data.nat_nombres}`
        //             : response.procesal === 'demandante'
        ...
        //         this.audiencia.exp_id = response.data.exp_id;
        //         console.log(response);
        //         this.audiencia.per_id = response.data.per_id;
        //     } catch (error) {
        ...
        guardarAlerta() {
            this.post({
                url: `${this.$store.getters.get__url}/alerta/store`,
                token: this.$store.getters.get__token,
                params: this.alerta
            })
                .then((response) => {
        ...
        guardarAudiencia() {
            this.post({
                url: `${this.$store.getters.get__url}/audiences/store`,
                token: this.$store.getters.get__token,
                params: this.audiencia
            })
                .then((response) => {
                    if (response.state === 0) {
                        console.log(response);
